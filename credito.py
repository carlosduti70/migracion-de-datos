...
val_numeric= ['cod_producto_socio', 'cod_cuenta_socio', 'cod_socio', 'num_credito', 'num_solicitud', 'val_capital', 'val_desembolso', 'val_saldo', 'val_tasa_interes', 'val_interes', 'val_gastos', 'val_gestion_cobro', 'val_ahorro', 'val_certificado', 'val_otros', 'val_impuesto', 'num_plazo', 'num_dias_amortizacion', 'num_cuotas', 'cod_destino', 'cod_oficial_credito', 'cod_oficina', 'cod_usrmod', 'cod_producto_encaje', 'cod_cuenta_encaje', 'val_cupo', 'val_encaje', 'cod_producto_certificado', 'cod_cuenta_certificado', 'num_cuotas_pagadas', 'val_mora', 'num_notificacion', 'val_notificacion', 'val_seguro', 'num_dia_pago', 'val_capital_mora', 'num_dias_mora', 'val_capital_vencido', 'val_multa', 'val_edificio', 'val_fondo', 'cod_notificacion', 'val_demanda', 'val_castigo', 'cod_tipo_credito', 'cod_clasif_credito', 'val_tir', 'val_tea', 'val_prima_descuento', 'val_provision_inc_constituida', 'val_provision_inc_reducida', 'val_provision_int', 'cod_cuenta_anterior', 'num_frecuencia_revision', 'cod_act_eco_receptora', 'cod_provincia_destino', 'cod_canton_destino', 'cod_instruccion_esperada', 'num_participantes_solidario', 'cod_parroquia_destino']
